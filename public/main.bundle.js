...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_auth_service__ = __webpack_require__("../../../../../src/app/services/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__variables_user__ = __webpack_require__("../../../../../src/app/variables/user.ts");
...
var AdminComponent = (function () {
    function AdminComponent(authService, flashMessage, searchService, fb) {
        var _this = this;
        this.authService = authService;
        this.flashMessage = flashMessage;
        this.searchService = searchService;
        this.fb = fb;
        this.searchTerm$ = new __WEBPACK_IMPORTED_MODULE_7_rxjs_Subject__["Subject"]();
        this.searchService.search(this.searchTerm$).subscribe(function (users) { return _this.users = users; });
        this.addUserForm = fb.group({
            firstname: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required])],
            lastname: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required])],
            email: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].email])],
            phone: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].pattern("[+-\d]+")])],
            address: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required])],
            area: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].pattern("[0-9]+"), __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].minLength(5)])],
            city: ['', __WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_8__angular_forms__["c" /* Validators */].required])],
            notes: [''],
        });
    }
    AdminComponent.prototype.ngOnInit = function () {
        this.curuser = this.authService.getUser();
        this.start = __WEBPACK_IMPORTED_MODULE_3_moment__(new Date()).format('YYYY-MM-DD[T]HH:mm');
        this.end = __WEBPACK_IMPORTED_MODULE_3_moment__(new Date()).format('YYYY-MM-DD[T]HH:mm');
        this.getConfirms();
    };
    ...
    AdminComponent.prototype.onEvents = function () {
        var _this = this;
        this.authService.getAllEvents(this.selectedUser._id, this.curuser.location).subscribe(function (events) {
            var eventit = events;
            eventit.forEach(function (event) {
                event.start = __WEBPACK_IMPORTED_MODULE_3_moment__(event.start).format('DD.MM.YYYY [klo] HH:mm');
                event.end = __WEBPACK_IMPORTED_MODULE_3_moment__(event.end).format('DD.MM.YYYY [klo] HH:mm');
    ...
    AdminComponent.prototype.getConfirms = function () {
        var _this = this;
        this.authService.getConfirmationEvents(this.curuser.location).subscribe(function (events) {
            var eventit = events;
            eventit.forEach(function (event) {
                event.start = __WEBPACK_IMPORTED_MODULE_3_moment__(event.start).format('DD.MM.YYYY [klo] HH:mm');
                event.end = __WEBPACK_IMPORTED_MODULE_3_moment__(event.end).format('DD.MM.YYYY [klo] HH:mm');
    ...
    AdminComponent.prototype.eventSearch = function (start, end) {
        var _this = this;
        end = __WEBPACK_IMPORTED_MODULE_3_moment__(this.end).format('YYYY-MM-DD[T]HH:mm');
        start = __WEBPACK_IMPORTED_MODULE_3_moment__(this.start).format('YYYY-MM-DD[T]HH:mm');
        var userId = null;
        var admin = true;
        this.authService.getEvents(start, end, userId, this.curuser.location, admin).subscribe(function (events) {
            _this.events = events;
    ...
    AdminComponent.prototype.getUsers = function () {
        ...
        this.authService.getAllUser(location).subscribe(function (users) {
    ...
    AdminComponent.prototype.addUser = function () {
        var _this = this;
        var user = new __WEBPACK_IMPORTED_MODULE_2__variables_user__["a" /* User */];
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Asiakas lisätty onnistuneesti', { cssClass: 'alert-success', timeout: 3000 });
            }
            else {
                _this.flashMessage.show('Jokin meni vikaan', { cssClass: 'alert-danger', timeout: 3000 });
            }
...
AdminComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4_angular2_flash_messages__["FlashMessagesService"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_5__services_search_service__["a" /* SearchService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_search_service__["a" /* SearchService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_8__angular_forms__["d" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__angular_forms__["d" /* FormBuilder */]) === "function" && _d || Object])
], AdminComponent);
...
var ChatComponent = (function () {
    function ChatComponent(chatService, authservice, flashMessage, router) {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_6_socket_io_client__(''); //'http://localhost:8081/' for local deployement empty for heroku.
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        this.socket.on('new-message', function (data) {
            ...
            if (data.message.room === JSON.parse(localStorage.getItem("userr")).room) {
                ...
                this.delay(20).then(function () { _this.scrollToBottom(); });
            }
        }.bind(this));
        //On disconnect
    ...
    ChatComponent.prototype.delay = function (ms) {
    ...
    ChatComponent.prototype.getChatByRoom = function (room) {
        ...
        this.chatService.getChatByRoom(room).then(function (res) {
            ...
            _this.socket.emit('connectmessage', room);
        }, function (err) {
            console.log(err);
        });
    };
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.checkOverlap = function (start, end) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.authService.getEvents(__WEBPACK_IMPORTED_MODULE_6_moment__(queryStart).format('YYYY-MM-DD[T]HH:mm'), __WEBPACK_IMPORTED_MODULE_6_moment__(queryEnd).format('YYYY-MM-DD[T]HH:mm'), user, _this.location, admin).subscribe(function (events) {
...
var LoginComponent = (function () {
    function LoginComponent(authService, router, flashMessage, location, fb) {
        ...
        this.loginForm = fb.group({
            ...
            location: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required])]
        });
        this.resetForm = fb.group({
            resetEmail: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].email])],
        });
    }
    ...
    LoginComponent.prototype.onResetSubmit = function () {
        var _this = this;
        var user = {
        ...
        this.authService.resetPassword(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Uusi salasanasi on lähetetty sähköpostiisi. Vaihda salasana kirjauduttuasi sisään.', {
                    cssClass: 'alert-success',
                    timeout: 7000
                });
                ...
                _this.flashMessage.show('Salasanan nollauksessa tapahtui virhe. Yritä uudestaan hetken päästä.', {
                    cssClass: 'alert-danger',
                    timeout: 7000
                });
            }
...
var ProfileComponent = (function () {
    function ProfileComponent(authService, flashmessage, router, fb) {
        ...
        this.changePwForm = fb.group({
            ...
            passwordConfirm: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required])]
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getAllEvents(this.authService.getUser().id, this.curuser.location).subscribe(function (events) {
            _this.events = events;
            _this.events.forEach(function (event) {
    ...
    ProfileComponent.prototype.areEqual = function (AC) {
...
var AuthService = (function () {
    function AuthService(http) {
        ...
        this.authHeaderi = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
    ...
    //Returns all users
    AuthService.prototype.getAllUser = function (location) {
    ...
    AuthService.prototype.getEvents = function (start, end, user, location, admin) {
    ...
    AuthService.prototype.getAllEvents = function (user, location) {
        return this.http.get(this.nodeUrl + 'events/getuserevents/' + user + "/" + location + "/", { headers: this.authHeaderi })
            .map(function (res) { return res.json(); }).catch(this.handleError);
    };
    AuthService.prototype.getConfirmationEvents = function (location) {
