...
var ChatComponent = (function () {
    function ChatComponent(chatService, authservice, flashMessage) {
        ...
        this.socket = __WEBPACK_IMPORTED_MODULE_4_socket_io_client__(''); //'http://localhost:8081/' for local deployement empty for heroku.
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_fullcalendar_dist_locale_all_js__ = __webpack_require__("../../../../fullcalendar/dist/locale-all.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_fullcalendar_dist_locale_all_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_fullcalendar_dist_locale_all_js__);
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.calElement = __WEBPACK_IMPORTED_MODULE_6_jquery__('#myCalendar');
        ...
        var clickFunc = function (calEvent, jsEvent, view) {
            if (calEvent.title) {
                ...
                this.end = __WEBPACK_IMPORTED_MODULE_4_moment__(calEvent.end).format('YYYY-MM-DD[T]HH:mm');
                this.start = __WEBPACK_IMPORTED_MODULE_4_moment__(calEvent.start).format('YYYY-MM-DD[T]HH:mm');
        ...
        var options = {
            ...
            events: function (start, end, timezone, callback) {
                end = __WEBPACK_IMPORTED_MODULE_4_moment__(end).add(6, 'hours').format('YYYY-MM-DD[T]HH:mm');
                start = __WEBPACK_IMPORTED_MODULE_4_moment__(start).subtract(6, 'hours').format('YYYY-MM-DD[T]HH:mm');
            ...
            validRange: function (nowDate) {
                return {
                    start: __WEBPACK_IMPORTED_MODULE_4_moment__(),
            ...
            dayClick: function (date, jsEvent, view) {
                ...
                _this.checkOverlap(date, __WEBPACK_IMPORTED_MODULE_4_moment__(date).add(_this.duration, 'hours')).then(function (res) {
                    if (view.type == 'month') {
                        ...
                        if (_this.title == undefined) {
                            ...
                            if (__WEBPACK_IMPORTED_MODULE_4_moment__(date).add(_this.duration, 'hours').get('hour') >= 18 &&
                                __WEBPACK_IMPORTED_MODULE_4_moment__(date).add(_this.duration, 'hours').get('minute') == 30 ||
                                __WEBPACK_IMPORTED_MODULE_4_moment__(date).add(_this.duration, 'hours').get('hour') > 18 ||
                                __WEBPACK_IMPORTED_MODULE_4_moment__(date).add(_this.duration, 'hours').get('hour') < 7) {
                                ...
                                _this.id = null;
                                _this.start = __WEBPACK_IMPORTED_MODULE_4_moment__(date).format('YYYY-MM-DD[T]HH:mm');
                                _this.end = __WEBPACK_IMPORTED_MODULE_4_moment__(_this.start).add(_this.duration, 'hours').format('YYYY-MM-DD[T]HH:mm');
    ...
    DashboardComponent.prototype.onTitleChange = function () {
        ...
        if ((this.start != undefined || this.id != undefined)) {
            this.end = __WEBPACK_IMPORTED_MODULE_4_moment__(this.start).add(this.duration, 'hours').format('YYYY-MM-DD[T]HH:mm');
            this.calElement.fullCalendar('select', this.start, this.end);
            this.checkOverlap(this.start, __WEBPACK_IMPORTED_MODULE_4_moment__(this.start).add(this.duration, 'hours')).then(function (res) {
                if (res >= 2) {
                    _this.flashMessage.show('Et voi varata yli 2 päällekkäistä tapahtumaa', { cssClass: 'alert-danger', timeout: 3000 });
                    _this.calElement.fullCalendar('unselect');
                    _this.id = null;
                ...
                if (__WEBPACK_IMPORTED_MODULE_4_moment__(_this.start).add(_this.duration, 'hours').get('hour') >= 18 &&
                    __WEBPACK_IMPORTED_MODULE_4_moment__(_this.start).add(_this.duration, 'hours').get('minute') == 30 ||
                    __WEBPACK_IMPORTED_MODULE_4_moment__(_this.start).add(_this.duration, 'hours').get('hour') > 18 ||
                    __WEBPACK_IMPORTED_MODULE_4_moment__(_this.start).add(_this.duration, 'hours').get('hour') < 7) {
                    _this.flashMessage.show('Aika menee aukiolo ajan yli', { cssClass: 'alert-danger', timeout: 3000 });
                    _this.calElement.fullCalendar('unselect');
                    _this.id = null;
                    _this.start = null;
    ...
    DashboardComponent.prototype.checkOverlap = function (start, end) {
        ...
        return new Promise(function (resolve, reject) {
            var user = null;
            var queryStart = __WEBPACK_IMPORTED_MODULE_4_moment__(start).subtract(12, 'h');
            var queryEnd = __WEBPACK_IMPORTED_MODULE_4_moment__(end).add(12, 'h');
            var admin = true;
            ...
            start = __WEBPACK_IMPORTED_MODULE_4_moment__(start).format('YYYY-MM-DD[T]HH:mm');
            end = __WEBPACK_IMPORTED_MODULE_4_moment__(end).format('YYYY-MM-DD[T]HH:mm');
            _this.authService.getEvents(__WEBPACK_IMPORTED_MODULE_4_moment__(queryStart).format('YYYY-MM-DD[T]HH:mm'), __WEBPACK_IMPORTED_MODULE_4_moment__(queryEnd).format('YYYY-MM-DD[T]HH:mm'), user, admin).subscribe(function (events) {
                events.forEach(function (event) {
                    if (__WEBPACK_IMPORTED_MODULE_4_moment__(start).isBetween(event.start, event.end)) {
                        //tallennetaan ajat.
                    ...
                    else if (__WEBPACK_IMPORTED_MODULE_4_moment__(end).isBetween(event.start, event.end)) {
                        //tallennetaan ajat.
                        overlapsStart[overlapsCounter] = event.start;
                        overlapsEnd[overlapsCounter] = event.end;
                        overlaped = true;
                    ...
                    else if (__WEBPACK_IMPORTED_MODULE_4_moment__(event.end).isBetween(start, end, null, '[]') &&
                        __WEBPACK_IMPORTED_MODULE_4_moment__(event.start).isBetween(start, end, null, '[)')) {
                        //tallennetaan ajat.
                        overlapsStart[overlapsCounter] = event.start;
                        overlapsEnd[overlapsCounter] = event.end;
                        overlaped = true;
                ...
                overlapsStart.forEach(function (eventti) {
                    ...
                    overlapsStart.forEach(function (event) {
                        ...
                        if (__WEBPACK_IMPORTED_MODULE_4_moment__(currentStart).isBetween(event, overlapsEnd[counter2], null, '[)')
                            || __WEBPACK_IMPORTED_MODULE_4_moment__(currentEnd).isBetween(event, overlapsEnd[counter2])) {
                            overlaps[counter1]++;
                        }
                        counter2++;
                    });
...
module.exports = "<div class=\"register-form\">\r\n  <h2 class=\"page-header\">Rekisteröityminen</h2>\r\n    <form [formGroup]=\"registerForm\" (ngSubmit)=\"onRegisterSubmit() ; registerForm.reset()\">\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('firstname').invalid && !registerForm.get('firstname').pristine}\">\r\n            <label>Etunimi</label>\r\n            <input type=\"text\" formControlName=\"firstname\" name=\"firstname\" class=\"form-control\" [ngClass]=\"{'form-control-danger': registerForm.get('firstname').invalid}\">\r\n        </div>\r\n\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('lastname').invalid && !registerForm.get('lastname').pristine}\">\r\n            <label>Sukunimi</label>\r\n            <input type=\"text\" formControlName=\"lastname\" name=\"lastname\" class=\"form-control\" [ngClass]=\"{'form-control-danger': registerForm.get('lastname').invalid}\">\r\n        </div>\r\n\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('email').invalid && !registerForm.get('email').pristine}\">\r\n            <label>Sähköposti</label>\r\n            <input type=\"text\" formControlName=\"email\" name=\"email\" class=\"form-control\" placeholder=\"Esimerkki@email.com\" [ngClass]=\"{'form-control-danger': registerForm.get('email').invalid}\">\r\n        </div>\r\n\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('username').invalid && !registerForm.get('username').pristine}\">\r\n            <label>Käyttäjänimi</label>\r\n            <input type=\"text\" formControlName=\"username\" name=\"username\" class=\"form-control\" [ngClass]=\"{'form-control-danger': registerForm.get('username').invalid}\">\r\n        </div>\r\n\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('password').invalid && !registerForm.get('password').pristine}\">\r\n            <label>Salasana</label>\r\n            <input type=\"password\" class=\"form-control\" formControlName=\"password\" name=\"password\" placeholder=\"Salasana\" [ngClass]=\"{'form-control-danger': registerForm.get('password').invalid && !registerForm.get('password').pristine}\">\r\n        </div>\r\n\r\n        <div class=\"form-group\" [ngClass]=\"{'has-error': registerForm.get('passwordConfirm').invalid && !registerForm.get('passwordConfirm').pristine}\">\r\n            <label>Kirjoita salasana uudelleen</label>\r\n            <input type=\"password\" class=\"form-control\" formControlName=\"passwordConfirm\" name=\"passwordConfirm\" placeholder=\"Salasana\" [ngClass]=\"{'form-control-danger': registerForm.get('passwordConfirm').invalid}\">\r\n        </div>\r\n\r\n        <button [disabled]=\"!registerForm.valid\" type=\"submit\" class=\"btn btn-primary\">Rekisteröidy</button>\r\n    </form>\r\n</div>\r\n"
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.areEqual = function (group) {
        return group.get('password').value === group.get('passwordConfirm').value
            ? null : { 'mismatch': true };
    };
