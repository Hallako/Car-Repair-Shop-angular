...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.updatename = function (event) {
        var _this = this;
        this.authService.getUserById(event).subscribe(function (user) {
            _this.eventUsername.name = user.firstname + ' ' + user.lastname;
        });
    };
...
var LoginComponent = (function () {
    function LoginComponent(authService, router, flashMessage, location, fb) {
        ...
        this.loginForm = fb.group({
            username: ['', __WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_5__angular_forms__["c" /* Validators */].required])],
